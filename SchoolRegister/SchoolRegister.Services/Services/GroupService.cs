...
namespace SchoolRegister.Services.Services
{
    public class GroupService : BaseService, IGroupService
    {
        ...
        public GroupService(ApplicationDbContext dbContext, UserManager<User> userManager) 
            : base(dbContext)
        {
        ...
        public GroupVm Remove(int? id = null)
        {
            if (id == null)
            {
            ...
            var obj = _dbContext.Groups.Where(x => x.Id == id).FirstOrDefault();

            _dbContext.Groups.Remove(obj);
            _dbContext.SaveChanges();
            var groupVm = Mapper.Map<GroupVm>(obj);
