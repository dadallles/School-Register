...
namespace SchoolRegister.Services.Services
{
    public class GradeService : BaseService, IGradeService
    {
        ...
        public GradeService(ApplicationDbContext dbContext, UserManager<User> userManager) 
            : base(dbContext)
        {
        ...
        public GradeVm AddGradeToStudent(AddGradeToStudentDto addGradeToStudentDto)
        {
            ...
            addGradeToStudentDto.DateOfIssue = DateTime.Now;
        ...
        public IEnumerable<GradeVm> GetGrades(Expression<Func<Grade, bool>> filterPredicate = null)
        {
            var gradeEntities = _dbContext.Grade.AsQueryable();

            if (filterPredicate != null)
            {
                gradeEntities = gradeEntities.Where(filterPredicate);
            }

            gradeEntities.OrderBy(x => x.SubjectId);
